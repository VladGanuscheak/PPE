...
{
    private:
        const std::string name = "square";         // имя фигуры
                                                    //
    ...
    public:
        square()
        {}
        square(int new_startX, int new_startY, int new_endX, int new_endY, int new_speed, int new_angle)        // параметризированный конструктор
        :   startX(new_startX)
        ,   startY(new_startY)
        {
        ...
        inline int get_centerX(){return centerX;}           // возврат позиции центра квадрата по Ox.
        void set_centerX(int newVal)                        // установка позиции центра квадрата по Ox.
        {
            centerX = newVal;
            return;
        }

        inline int get_centerY(){return centerY;}           // возврат позиции центра квадрата по Oy.
        void set_centerY(int newVal)                        // установка позиции центра квадрата по Oy.
        {
            centerY = newVal;
            return;
        }

        inline int get_speed(){return speed;}               // возврат скорости движения квадрата
        void set_speed(int newVal)                          // установка скорости движения квадрата
        {
            return;
        }

        inline int get_angle(){return radius;}              // возврат угла движения квадрата
        void set_angle(int newVal)                          // установка угла движения квадрата
        {
            return;
        }

        inline int get_radius(){return radius;}             // возврат радиуса квадрата
        void set_radius(int newVal)                         // установка радиуса квадрата = -1 всегда
        {
            return;
        }
        ...
        void set_RGB(int R, int G, int B)                   // установка цвета квадрата
        {
            RGB_RED = R;
            RGB_GREEN = G;
            RGB_BLUE = B;
