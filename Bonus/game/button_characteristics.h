...
typedef struct button_characteristics
{
   ...
   int height;                                                             // расстояние между левым верхнем и правым верхнем
                                                                           ...
                                                                           //
   int digit;                                                              // цифра, отображаемая кнопкой
                                                                           //
   bool can_klick;                                                         // Истинна - можно нажать, иначе - нельзя.
                                                                           //
   ...
   ,  can_klick(true)
   {}
   button_characteristics(int hor_pos, int vert_pos, int wid, int hei, int dig = 0, bool klick = true)     // параметризованный конструктор
